    ...
    <div className="landing-shell bg-background text-on-background h-screen flex flex-col md:flex-row font-body-gothic textured-bg overflow-hidden">
      ...
      <main className="landing-stage ritual-stage flex-grow flex flex-col relative overflow-hidden border-b-4 md:border-b-0 md:border-r-4 border-secondary demonic-bg justify-center p-8 z-10 h-1/2 md:h-full">
        ...
        >
          ...
          {!isConnected && (
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 px-3 py-1.5 border border-red-500/50 bg-red-950/90 text-red-400 text-[10px] font-body-gothic flex items-center gap-1.5 animate-pulse rounded shadow-lg">
      ...
      >
        <div className="px-6 md:px-8 space-y-8 flex-grow flex flex-col justify-center">
          ...
          <div className="space-y-3">
            <h2 className="font-body-gothic text-base font-semibold text-zinc-200 border-b border-zinc-700/50 pb-2">
              Danh tính của bạn
            </h2>
            <input
              type="text"
              ...
              className="w-full font-body-gothic text-base p-3 border border-zinc-700/40 focus:border-zinc-400/60 focus:ring-0 text-center bg-black/50 text-zinc-100 transition-all placeholder-zinc-600 rounded-sm"
            />
          </div>
          ...
          <div className="space-y-2">
            <button
              ...
              disabled={isSubmitting}
              className="group w-full bg-transparent text-zinc-400 hover:text-[#e9c349] font-body-gothic font-semibold text-lg py-2.5 transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-30 disabled:cursor-not-allowed"
            >
              Tạo Phòng Chơi
            ...
            >
              <form onSubmit={handleJoinRoom} className="space-y-2 pt-1">
                ...
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="w-full font-body-gothic font-semibold text-xs py-2 text-zinc-500 hover:text-zinc-200 transition-colors cursor-pointer border border-zinc-800 hover:border-zinc-600 rounded-sm"
                >
                  Xác nhận
                </button>
              </form>
          ...
          <div className="pt-2 border-t border-outline-variant/20">
            <Link
              href="/offline"
              className="group w-full bg-black/35 text-[#e9c349] hover:text-white font-body-gothic font-semibold text-base py-3 transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer border border-[#e9c349]/20 hover:border-[#e9c349]/50 rounded-sm"
            >
          ...
          {/* Error Message */}
          {error && (
            <div className="p-3 border border-red-500/20 bg-red-950/20 text-red-200 text-xs font-body-gothic text-center rounded-sm">
              {error}
            </div>
          )}
        </div>
        ...
        <div className="mt-auto pt-4 px-6 border-t border-outline-variant/20 mx-4">
          <button
            ...
            className="group w-full flex items-center justify-center gap-2 text-zinc-500 hover:text-[#e9c349] py-2 transition-colors cursor-pointer text-xs font-body-gothic font-semibold"
          >
            GIỚI THIỆU TRÒ CHƠI
